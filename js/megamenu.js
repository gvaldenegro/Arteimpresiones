(function(){
	...
	(jQuery)('#Main-nav ul.dropdown').hover(function(){
		...
		function update(){
			$that.find('.megamenu').each(function(){
				var $this = (jQuery)(this),
					...
					megaMenuWidth,
					mainMenuWidth = $('#Main-nav #MegaMenu_full').width(),
					dropdownWidth = 295,
					longestMenu = 1;
	...
	(function hoverdelay(){
		(jQuery)('#Main-nav #MegaMenu_full:not(.expanded) .top-bar-section li.has-dropdown').each(function(){
